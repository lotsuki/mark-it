  ...
  return (
    <nav className="navbar">
      <div className="logo-wrapper">
        ...
        <svg className="icon-bookmark" xmlns="http://www.w3.org/2000/svg" width="70" height="50" viewBox="20 -15 85 85" fill="#fff">
      ...
      <div className="icons-wrapper">
        <div className="plus-icon" data-testid="plus-icon" onClick={displayForm}>
          <svg className="icon-plus" xmlns="http://www.w3.org/2000/svg" width="70" height="50" viewBox="20 -15 85 85" fill="#fff">
            <title>plus</title>
            <path d="M31 12h-11v-11c0-0.552-0.448-1-1-1h-6c-0.552 0-1 0.448-1 1v11h-11c-0.552 0-1 0.448-1 1v6c0 0.552 0.448 1 1 1h11v11c0 0.552 0.448 1 1 1h6c0.552 0 1-0.448 1-1v-11h11c0.552 0 1-0.448 1-1v-6c0-0.552-0.448-1-1-1z"></path>
          </svg>
        </div>
        <div className="edit-icon" data-testid="edit-icon" onClick={displayEdit}>
          <svg className="icon-pencil" xmlns="http://www.w3.org/2000/svg" width="70" height="50" viewBox="20 -15 85 85" fill="#fff">
            <title>pencil</title>
