...
const IconCustomMenu = ({ openCustomMenu }) => {
  return (
    <svg className="icon-custom-menu" onClick={openCustomMenu} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"width="25" height="25"viewBox="0 0 32 32" fill="gray" >
